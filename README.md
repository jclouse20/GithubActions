[![Run App JacobClouse](https://github.com/jclouse20/GithubActions/actions/workflows/run-app.yaml/badge.svg?branch=master)](https://github.com/jclouse20/GithubActions/actions/workflows/run-app.yaml)
